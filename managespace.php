	...
	<div calss="nva-top">
		...
		<div class="mbar">
			<ul>
				...
				echo'<li><a href="managespace.php" style="background-color: #3F3F3F; color: #E8E7E3;">周排程</a></li>';
				echo'<li><a href="managespaces.php">日排程</a></li>';
				?>
		...
		<div class="ab">
			閉館
			<div class="b" style="background-color: rgb(204, 204, 204);padding:9px;width: 10px;height: 10px;"></div>
		...
		<div class="ad">
		 ...
		 <?php
			...
			foreach($rows as $row)
			{
				...
				if($check=='N')
				{
					echo'<div class="administrate"  style="background-color: rgb(204, 204, 204);">';
				}
				else if($check=='Y')
				{
				...
				$sid=$row['sid'];
				echo'<a href="spacemotify.php?sid='.$sid.'&category=1">設定</a>';
				echo'</div>';
				echo'</div>';
			}
