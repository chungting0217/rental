...
if(isset($confim))
{
	...
	$date=$_SESSION['day'];
	 	 $sqlcmd = "SELECT * FROM specialspaces WHERE date='$date' AND sname='$sname'";
		  ...
		  foreach($rss as $r)
		  {
			$sportid=$r['sportid'];
			$sport=$r['sport'];
			$rsqlcmd='INSERT INTO specialspacetime (sid,sportid,name,time,people,limitpeople) VALUES ('
	 	 ."?,?,?,?,?,?)";
		...
		<div class="add-space">
			<form enctype="multipart/form-data" action="" method="POST">
				...
				$sqlcmd = "SELECT * FROM specialspaces WHERE date='$date' AND sname='$sname'";
					...
					$sqlcmd = "SELECT * FROM specialspacessport WHERE sid='$sid'";
					$rs = querydb($sqlcmd, $db_conn);
					foreach($rs as $rss)
					{
