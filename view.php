	...
	<div calss="nva-top">
		...
		<div class="mbar">
			<ul>
				...
				echo'<li><a href="view.php?sportid='.$sportid.'&sid='.$sid.'&time='.$time.'&category='.$category.'" style="background-color: #3F3F3F; color: #E8E7E3;">未繳費</a></li>';
				echo'<li><a href="checkview.php?sportid='.$sportid.'&sid='.$sid.'&time='.$time.'&category='.$category.'">已繳費</a></li>';
				?>
		...
		<div class="show_s">
		 ...
		 <?php
			...
			if($category==1)
			{
				$sql="SELECT * FROM spacereserve WHERE sid='$sid' AND sportid='$sportid' AND time='$time' AND category='$category'";
			 ...
			 echo'<a href="pay.php?sportid='.$sportid.'&sid='.$sid.'&Aid='.$Aid.'&time='.$time.'&category='.$category.'">已繳費</a>';
